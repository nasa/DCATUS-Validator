...
try {
    ...
    results.valid ? console.log("Validation succeeded. The file is valid according to the schema.") : console.log("Validation failed. The file is not valid according to the schema.");
